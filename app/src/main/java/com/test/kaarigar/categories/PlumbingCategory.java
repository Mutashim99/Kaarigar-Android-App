...
public class PlumbingCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardItemList.add(new categorymodel(R.drawable.pop1, "(4.5)", "Pipe Repair", "Rs 1500", Signup.class));
        cardItemList.add(new categorymodel(R.drawable.pop2, "(4.0)", "Drain Cleaning", "Rs 2000", chooselocation.class));
        cardItemList.add(new categorymodel(R.drawable.pop3, "(4.7)", "Leak Fixing", "Rs 1000", Onboarding.class));
        cardItemList.add(new categorymodel(R.drawable.pop4, "(4.2)", "Water Heater Repair", "Rs 1800", Login.class));
